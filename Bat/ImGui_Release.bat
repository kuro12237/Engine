...
MSBuild "ImGui\ImGui.vcxproj" ^
 ...
 /p:OutDir=../Generated\output\ImGui\Release\ ^
 /m

IF EXIST "Generated\output\ImGui\Release\ImGui.lib" (
    mkdir "Externals\ImGui\lib\Release" >nul 2>&1
    copy /Y "generated\output\ImGui\Release\ImGui.lib" "Externals\ImGui\lib\Release\"
) ELSE (
